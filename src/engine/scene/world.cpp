...
// GLOBALS
World World::d_instance = World();

// MUTATOR FUNCTIONS
void World::moveView( float dx, float dy, bool clip )
{
...
void World::setViewScale( float scale, bool forceFit )
{
    assert( scale > 0.0f );
...
// GLOBAL FUNCTIONS
void World::initialize( const sgds::RectangleBounds& screenSize,
                        ...
                        float dpPerWU )
{
    ...
    d_instance = World( worldSpace, viewSpace, dpPerWU, pxPerDP );
}

// GLOBAL HELPER FUNCTIONS
sgds::RectangleBounds World::calculateViewSpace(
