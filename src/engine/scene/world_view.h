...
class WorldView
{
  private:
    ...
    WorldView( const sgds::RectangleBounds& worldSpace,
    ...
    WorldView( const WorldView& world );
      // Constructs a copy of the given world.

    // OPERATORS
    WorldView& operator=( const WorldView& world );
...
// CONSTRUCTORS
inline
WorldView::WorldView() : d_worldSpace( 0.0f, 0.0f, 1.0f, 1.0f ),
...
inline
WorldView::WorldView( const sgds::RectangleBounds& worldSpace,
                      const sgds::RectangleBounds& viewSpace,
                      float dpPerWU, float pxPerDP )
...
inline
WorldView::WorldView( const WorldView& world )
...
// OPERATORS
inline
WorldView& WorldView::operator=( const WorldView& world )
{
...
// ACCESSOR FUNCTIONS
inline
float WorldView::left() const
{
    return d_worldSpace.left();
}

inline
float WorldView::top() const
{
    return d_worldSpace.top();
}

inline
float WorldView::right() const
{
    return d_worldSpace.right();
}

inline
float WorldView::bottom() const
{
    return d_worldSpace.bottom();
}

inline
float WorldView::width() const
{
    return d_worldSpace.width();
}

inline
float WorldView::height() const
{
    return d_worldSpace.height();
}

inline
float WorldView::viewLeft() const
{
    return d_workingViewSpace.left();
}

inline
float WorldView::viewTop() const
{
    return d_workingViewSpace.top();
}

inline
float WorldView::viewRight() const
{
    return d_workingViewSpace.right();
}

inline
float WorldView::viewBottom() const
{
    return d_workingViewSpace.bottom();
}

inline
float WorldView::viewWidth() const
{
    return d_workingViewSpace.width();
}

inline
float WorldView::viewHeight() const
{
    return d_workingViewSpace.height();
}

inline
float WorldView::viewScale() const
{
    return d_viewScale;
}

inline
const sgds::RectangleBounds& WorldView::viewSpace() const
{
    return d_workingViewSpace;
}

inline
const sgds::RectangleBounds& WorldView::worldSpace() const
{
    return d_worldSpace;
}
...
// MUTATOR FUNCTIONS
inline
void WorldView::resize( const sgds::RectangleBounds& worldSpace )
{
...
inline
void WorldView::setViewPosition( float x, float y, bool clip )
{
    moveView( x - viewLeft(), y - viewTop(), clip );
}

inline
void WorldView::scaleView( float dS, bool forceFit )
{
...
// MEMBER FUNCTIONS
inline
float WorldView::wuToDP( float wu ) const
{
    return wu * d_dpPerWU;
}

inline
float WorldView::dpToWU( float points ) const
{
    return points / d_dpPerWU;
}

inline
float WorldView::dpToPX( float points ) const
{
    return points * d_pxPerDP;
}

inline
float WorldView::pxToDP( float pixels ) const
{
